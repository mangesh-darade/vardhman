...
class Urban_piper  extends MY_Controller{
    ...
    *==========================================================================*/ 
    ...
    public function testcategory() {
     ...
     $getcategory = $this->UPM->getMasterCategories(1);
    ...
    public function get_item_image_exist($image='') {
       ...
       if($getcategory->image != ''){
           $file_headers = @get_headers(site_url('assets/uploads/thumbs/') . $image);

           if($file_headers[0] == 'HTTP/1.1 200 OK'){
              $img_url =  site_url('assets/uploads/thumbs/') . $image;
           } else {
                $file_headers2 = @get_headers(site_url('assets/uploads/') . $image);
                if($file_headers2[0] == 'HTTP/1.1 200 OK'){
    ...
    public function action($keytype=NULL, $id=NULL, $action_ref_id=NULL, $bulk_id = NULL, $store_id=NULL){
        ...
        break;
            ...
            case 'add_store_category': // Single Category Add
                ...
                //$storeData = $this->UPM->getallstore($this->uri->segment(5));
