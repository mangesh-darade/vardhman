...
class Customers extends MY_Controller {
    ...
    function getCustomers() {
         ...
         */
        $this->datatables
                ->select("id, company, name, email, phone, price_group_name, customer_group_name, gstn_no, deposit_amount,award_points");
    ...
    function import_csv() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (isset($_FILES["csv_file"])) /* if($_FILES['userfile']['size'] > 0) */ {
                ...
                $keys = array('company', 'name', 'email', 'phone', 'address', 'city', 'state', 'state_code', 'postal_code', 'country', 'gstn_no', 'vat_no', 'cf1', 'cf2', 'cf3', 'cf4', 'cf5', 'cf6');
     ...
     * @param type $id
     */
    function getCustomereshop($id = NULL) {
        // $this->sma->checkPermissions('index');
        $row = $this->companies_model->getCompanyByID($id);
    ...
    public function getGiftBalance() {
        ...
        echo json_encode($retrun_option);
    }
