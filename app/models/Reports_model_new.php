...
class Reports_model_new extends CI_Model {
    ...
    public function getSaleGstData($year = NULL, $month = NULL, $warehouse = NULL, $biller = NULL, $sale_items = FALSE) {
        ...
        $qry = "SELECT s.id sale_id, s.`invoice_no`, s.`reference_no`, s.`date`, s.`reference_no`, s.`customer_id`, s.`customer`, c.`gstn_no`,c.state as `state_code`, s.`biller_id`, s.`biller`, 
    ...
    public function getPurchaseGstData($year = NULL, $month = NULL, $warehouse = NULL, $supplier = NULL) {
