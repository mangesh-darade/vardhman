...
class Api3_model extends CI_Model {
    ...
    public function get_warehouses() {
        $select = ($this->select_fields != '') ? $this->select_fields : "id,code,name,address,city,state,state_code,postal_code,country,map,phone,email,price_group_id,is_active,is_deleted,is_disabled,pos_biller_id,eshop_biller_id,in_eshop";
    ...
    public function get_offlinepos_pos_settings() {
        ...
        $select = "pos_id as id,eshop_order_tax,cat_limit,pro_limit,default_category,default_customer,default_biller,display_time,cf_title1,cf_title2,cf_value1,cf_value2,receipt_printer,cash_drawer_codes,focus_add_item,add_manual_product,customer_selection,add_customer,toggle_category_slider,toggle_subcategory_slider,cancel_sale,suspend_sale,print_items_list,finalize_sale,today_sale,open_hold_bills,close_register,submit_and_print,other,keyboard,pos_printers,java_applet,product_button_color,tooltips,paypal_pro,stripe,rounding,char_per_line,pin_code,after_sale_page,item_order,authorize,toggle_brands_slider,instamojo,ccavenue,paytm,paytm_opt,credit_card,debit_card,gift_card,neft,google_pay,swiggy,zomato,ubereats,magicpin,UPI_QRCODE,complimentary,paynear,payumoney,award_point,pos_screen_products,pos_theme,default_eshop_theame,eshop_free_delivery_on_order,invoice_auto_sms,offers_status,active_offer_category,recent_pos_limit,display_token,alert_qty_auto_email,daily_sale_auto_email,display_category,pos_amount,display_seller,product_variant_popup,use_product_price,cart_show_pos2,change_qty_as_per_user_price,order_receipt,print_all_category,categorys,display_qr_code_scanner";
    ...
    public function fetchTableData($tablename) {
        ...
        $tableFields['sma_users'] = 'id,username,password,salt,email,active,first_name,last_name,company,phone,avatar,gender,group_id,warehouse_id,biller_id,company_id,show_cost,show_price,award_points,view_right,edit_right,allow_discount,offline_mobile_app_access,offline_windows_app_access';
...
//05-09-2019
   ...
   function getDeletedList($data, $FieldId, $FieldValue, $start_limit='', $end_limit=''){
    ...
    function getUserList($data, $start_limit = '', $end_limit = '') {
        $SelectFields = 'email, active, first_name, last_name, company, phone, group_id, id as user_id';
        if ($data['updated_at'] != '') {
