    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <input type="hidden" name="pageAction" id="pageAction" value="add_transfer">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                        <?php if ($Owner || $Admin  || $GP['transfers-date']) { ?>
...
<!--                                            <br/>
                        ...
                        <div id="search_product">
                            ...
                            <div class="col-md-12">
                                ...
                                <div
                                    class="from-group"><?php echo form_submit('add_transfer', $this->lang->line("submit"), 'id="add_transfer" disabled="disabled" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
