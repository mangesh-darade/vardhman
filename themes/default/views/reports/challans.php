...
<script>
    $(document).ready(function () {
        var oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getChallansReport/?v=1'. $v) ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                nRow.id = aData[10]; 
                nRow.className = (aData[6] > 0) ? "challan_link2" : "challan_link2 warning";
                return nRow;
            },
            "aoColumns": [{"mRender": fld}, null, null, null, null  , { // {"bSearchable": false},
                //"bSearchable": false,
                "mRender": pqFormat
            }, {"mRender": currencyFormat, "bSearchable": false}, {"mRender": currencyFormat, "bSearchable": false}, {"mRender": currencyFormat, "bSearchable": false}, {"mRender": row_status}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('challans_report'); ?> <?php
            if ($this->input->post('start_date')) {
         ...
         <div  >
            ...
            <div class="col-sm-offset-4 col-sm-2" > 
                ...
                <?php $startcount=0;$count=$salecount;$addcount =1000;$endcount=1000;$seccount=0;
                ?>
                <div class="col-sm-2">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/challans"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <?php if($Settings->product_serial) { ?>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?= form_input('serial', (isset($_POST['serial']) ? $_POST['serial'] : ""), 'class="form-control tip" id="serial"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                         <div class="col-sm-4">                        
                    ...
                    <div class="form-group">
                        <div class="controls"> 
                            ...
                            <!--<input type="button" id="report_reset" data-value="<?=base_url('reports/challans');?>" name="submit_report" value="Reset" class="btn btn-warning input-xs">-->
    ...
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            if(limitcnt=='0'){
              ...
              <?php 
              $v .= "&strtlimit="?>
               window.location.href = "<?=site_url('reports/getChallansReport/pdf/?v=1'.$v)?>"+limitcnt;
        ...
        $('#xls').click(function (event) {
            ...
            if(limitcnt=='0'){
              ...
              <?php 
              $v .= "&strtlimit="?>
              window.location.href = "<?=site_url('reports/getChallansReport/0/xls/?v=1'.$v)?>"+limitcnt;
              $("#limitpdf").val(0).change(); 
              return false;
            ...
            // event.preventDefault();
            // window.location.href = "<?=site_url('reports/getChallansReport/0/xls/?v=1'.$v)?>";
            // return false;
        });

        $('#image').click(function (event) {
            event.preventDefault();
			  window.location.href = "<?=site_url('reports/getChallansReport/0/0/img/?v=1'.$v)?>";
			/*
            html2canvas($('.box'), {
