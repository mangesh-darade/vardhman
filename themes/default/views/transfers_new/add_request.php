    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("transfersnew/request", $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php $post = array( 'request' => lang('Request'));
                        ...
                        <div class="col-md-4">
                            <div class="form-group" style="margin-bottom:5px;">
								<?php $ShippingReadonly=''; if (!$Admin) { $ShippingReadonly = 'readonly'; } ?>
                                <?= lang("shipping", "toshipping"); ?>
                                <?php echo form_input('shipping', '',  'class="form-control input-tip" '.$ShippingReadonly.' id="toshipping"'); ?>
                            </div>
                        </div>
