...
<script>
    $(document).ready(function () {
        var oTable = $('#TOData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('transfersnew/getTransfers').$v  ?>',
			...
			var ntdCells = nRow.getElementsByTagName('td');
				...
				if(aData[8]=='partial_completed')
					ntdCells[8].innerHTML = '<span style="background-color:#5cb85c; color:#fff; font-size:11px; padding:2px; font-weight:bold;" >Partial Completed</span>';
                ...
                nRow.id = aData[0];
                nRow.className = "transfernew_link";
                return nRow;
            },
...
<?php if ($Owner || $GP['bulk_actions']) {
    echo form_open('transfersnew/transfer_actions', 'id="action-form"');
} ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= site_url('transfersnew/add') ?>">
