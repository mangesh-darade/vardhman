...
//                                      
                    ...
                    if ($inv->coupon_code) {
                        ...
                        <div class="well well-sm" style="text-align:<?= (isset($default_printer->footer_align) && $default_printer->footer_align != '') ? $default_printer->footer_align : 'center' ?>;">
...
if($_SERVER['HTTP_REFERER'] == base_url('pos')){
  if($pos_settings->order_receipt){ ?>
    
   
        
    <div class="page-break" id="order_print_bill"  style="display:none">
        <style>
        @media all {
        ...
        #orderTable, th, td { border-collapse:collapse; border-bottom: 1px solid #CCC; } 
        .no-border { border: 0; } 
        ...
        <div class="text-center">
              ...
              <h4>Order</h4>
              <h5>Token No: <?= $inv->kot_tokan?></h5>
              <h5> <?= $inv->customer  ?></h5>
              <h5> <?php echo date('h:i A', strtotime( $inv->date)); ?></h5>
        </div> 
                ...
                <?php
                 ...
                 ?>
                    <tr>
                        ...
                        <td><?= number_format($rowItems->quantity,2) ?></td>
                    </tr>
                <?php } else{ 
    ...
    <script>
        ...
        function openWin()
        {
            ...
            winPrint.document.write($('#order_print_bill').html());
