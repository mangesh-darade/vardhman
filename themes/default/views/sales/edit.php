...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= ($formaction=='edit')? lang('edit_sale') : 'Edit Challan'; ?></h2>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                ?>
                <input type="hidden" name="redirects" value="<?= $lasturl[$last_segment-1].'/'.$lasturl[$last_segment] ?>"/>
