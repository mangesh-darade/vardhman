...
<!-- banner -->
<style>.option{ width:18%;height:25px; padding:0 10px;}</style>
        ...
        <div class="product-price" style="margin: 10px 0;">
            <?php
                if($product['promotion']){                
                     echo "<h3>Price : $currency_symbol ". number_format($product['promo_price'], 2). " <del> ". number_format($product['price'], 2) . "</del></h3>";
                } else {
                    echo "<h3>Price :  $currency_symbol ". number_format($product['price'], 2) . "</h3>";
                } 
            ?>
        </div>  
            ...
            <?php if($veriants){?>
                ...
                <select class="form-control option" style="margin:10px 0;" id="variants_<?=$product['id']?>" name="variants_<?=$product['id']?>">
