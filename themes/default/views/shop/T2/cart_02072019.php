...
?> 
    ...
    <input type="hidden" name="cart_sub_total"  id="cart_sub_total" value="<?= $cartSubtotal;?>" />                   
    <input type="hidden" name="cart_tax_total" id="cart_tax_total" value="<?= $totalTax;?>" />
    ...
    <input type="hidden" name="cart_gross_total" id="cart_gross_total" value="<?= number_format($grossTotal,2);?>" />
