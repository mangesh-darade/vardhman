    ...
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
                ...
                console.log(id);
                 var url = '<?= site_url("Customers/getGiftBalance/") ?>?id='+id;
                    ...
                    success:function(result){
                        console.log(result);
                        nCells[10].innerHTML =  currencyFormat(result);
                       // nRow.className = "text-right text-capitalize";
                    }, error:function(){
                        nCells[10].innerHTML = currencyFormat(0);
                    }
                });
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null, null, null,{"mRender": currencyFormat},  null,{"mRender": currencyFormat}, {"bSortable": false}]
        }).dtFilter([
...
//            {column_number: 7, filter_default_label: "[<?=lang('vat_no');?>]", filter_type: "text", data: []},
            ...
            {column_number: 10, filter_default_label: "[<?=lang('gift_card');?>]", filter_type: "text", data: []},
        ], "footer");
