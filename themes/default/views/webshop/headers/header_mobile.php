            ...
            <div class="row">
                ...
                <div class="handheld-header-links">
                    <ul class="columns-3">
                        ...
                        <li class="compare">
                            <a href="<?= base_url('#compare') ?>" class="has-icon">
                ...
                <div class="row">
                                ...
                                if (is_array($main_categories)) {
                                    foreach ($main_categories as $category) {
                                        ...
                                        <li class="menu-item animate-dropdown">
                                            <a title="<?= $category->name ?>" href="#"><?= $category->name ?></a>
                                        </li>
                                        <?php }//end else ?>
                                <?php
                                    }//end foreach
                    ...
                    <div class="site-search">
                        <div class="widget woocommerce widget_product_search">
                            <form role="search" method="post" action="<?= base_url('webshop/search_products') ?>" class="woocommerce-product-search" >
                                <label class="screen-reader-text" for="woocommerce-product-search-field-0">Search for:</label>
                                <input type="search" id="woocommerce-product-search-field-0" class="search-field" placeholder="Search products&hellip;" value="" name="search_products" />
