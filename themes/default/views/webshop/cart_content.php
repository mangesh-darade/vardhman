                                    ...
                                    <tr>                                                                 
                                        ...
                                        <td data-title="Price" class="product-price">
                                            <span class="woocommerce-Price-amount amount">
                                                <span class="woocommerce-Price-currencySymbol">Rs. </span><?= number_format($item['product_price'], 0) ?>
                                            </span>
                                        </td>
                                        ...
                                        <td data-title="Total" class="product-subtotal">
                                            <span class="woocommerce-Price-amount amount">
                                                <span class="woocommerce-Price-currencySymbol">Rs. </span> <span class="item_subtotal_<?= $itemKey ?>"><?= number_format((float) $item['quantity'] * (float) $item['product_price'], 0) ?></span>
                                            </span>
