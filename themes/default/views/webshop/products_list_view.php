<div id="list-view" class="tab-pane active" role="tabpanel">
    <div class="woocommerce columns-1">
        ...
        <?php
        $maxPrice = 0;
        $section_key = "list_view";
        
        if(is_array($listItems)){
            foreach ($listItems as $Item) {
                
                $product = $Item;                
                $product_hash               = md5($Item['id'] . $section_key);
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <div class="product-info">
                            ...
                            <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="<?=base_url("webshop/product_details/".md5($Item['id']))?>">
                                ...
                                <div class="techmarket-product-rating">
                                    <div title="Rated 5.00 out of 5" class="star-rating">
                                        <span style="width:<?=((float)$Item['ratings_avarage']*100/5)?>%"> Rated
                                            <strong class="rating ratings_avarage_<?=$product_hash?>"><?=$Item['ratings_avarage']?></strong> out of 5</span>
                                    </div>
                                    <span class="review-count review_count_<?=$product_hash?>">( <?=$Item['ratings_count']?$Item['ratings_count']:0?> )</span>
                                    <a rel="nofollow" class="woocommerce-review-link" href="#reviews">(<span class="count"><?= !empty($Item['comments_count']) ? $Item['comments_count'] : '0'?></span> customer review)</a>
                                </div>                                 
                            </a>
                            ...
                            <!-- .brand -->
                            <div class="woocommerce-product-details__short-description short_description_<?=$product_hash?>">
