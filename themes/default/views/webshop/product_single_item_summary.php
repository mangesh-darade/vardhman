                ...
                <p class="price">                
                    <ins>
                        <span class="woocommerce-Price-amount amount">
                            <span class="woocommerce-Price-currencySymbol">Rs. </span><span id="display_unit_price"><?=number_format($sale_price,0)?></span></span>
                    </ins>
                    <?php if($product_price['unit_price'] < $product_price['real_unit_price']) { ?>
                    <del class="text-danger">
                        <span class="woocommerce-Price-amount amount ">
                            <span class="woocommerce-Price-currencySymbol">Rs. </span><?= number_format($product_price['real_unit_price'],0)?></span>
                    </del>
                    <?php } ?>
                </p>
                <!-- .single-product-header -->
    ...
    <div class="product-actions-wrapper">
        <div class="product-actions">
            <div class="availability">
                ...
                <?php
                if($product['quantity']){
                    echo '<p class="stock in-stock">'. number_format($product['quantity'],0) . " in stock </p>";
                } else {
